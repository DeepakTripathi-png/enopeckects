<aside class="sidebar-wrapper">
    <div class="sidebar-header">
      <div class="logo-icon">
        <a class="sidebar__main-logo" href="{{ route('admin.dashboard') }}"><img src="{{ asset('assets/images/dashboard-logo.svg')}}" class="logo-img w-50" style="width: 80% !important;" alt=""></a>
      </div>
